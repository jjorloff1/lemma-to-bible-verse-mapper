...
RSpec.describe "Map Lemma to LXX Bible Verse", type: :feature do
  ...
  it "Creates a map of Words to LXX Verses" do
    first_word_occurrence_key = get_first_word_occurrence_map("./private_data/lxx/word-keys.csv")

    word_key_to_verse = get_word_key_to_verse_map("./private_data/lxx/word-key-to-verse.csv")

    first_word_occurrence, tabbed_data = get_first_word_occurrence_data(book_abbreviations, first_word_occurrence_key, word_key_to_verse)
  ...
  it "Creates a map of Unmarked Words to LXX Verses" do
    first_word_occurrence_key = get_first_word_occurrence_map("./private_data/lxx/word-keys-unmarked.csv")
